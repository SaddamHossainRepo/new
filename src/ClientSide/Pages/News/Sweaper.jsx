        ...
        <>
            <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
                ...
                <div>
                    ...
                    <SwiperSlide className='single-swiper pb-[56px] pr-12'>
                        ...
                        <div className='single-card-div pb-10'>
                            ...
                            <div className="carousel-card card-1 mr-[83px] w-[485px]  bg-base-100 shadow-xl">
                                ...
                                <div className="carousel-des-div">
                                    <h5 className='title-2 carousel-title mb-[25px] font-bold  pl-5 text-[25px]'>Eight Selected for the Minnesota Young American Leaders Program</h5>
                                    <h5 className='title-3 carousel-des mb-[40px] text-[#7B7882]  pl-5 text-[25px]'>(KNSI) — Eight young professionals from around the St. Cloud area have been selected for the 2023....</h5>
                                    <div className=" justify-start pl-5 pb-5">
                                        <div className="badge mt-0  learn-more">READ MORE</div>
                                        <div className='w-24 pt-1'>
                                            <img src={line} alt="" />
                        ...
                        <div className='single-card-div pb-10'>
                            ...
                            <div className="carousel-card card-1 mr-[83px] w-[485px]  bg-base-100 shadow-xl">
                                ...
                                <div className="carousel-des-div">
                                    <h5 className='title-2 carousel-title mb-[25px] font-bold pl-5 text-[25px]'>Rural Minnesota facing child-care deserts as pandemic makes bad situation worse</h5>
                                    <h5 className='title-3 carousel-des mb-[40px] text-[#7B7882] pl-5 text-[25px]'>In recent months, Daisane’s Blooming Kids Child Care Center in St. Cloud has averaged about....</h5>
